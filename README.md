...
[![Version](https://img.shields.io/badge/version-1.0.0-green.svg)](https://github.com/NeoMonserrat/DrumXRoll/releases)
...
[![Issues](https://img.shields.io/github/issues/NeoMonserrat/DrumXRoll)](https://github.com/NeoMonserrat/DrumXRoll/issues)

<br />

[Report Bug](https://github.com/NeoMonserrat/DrumXRoll/issues/new?template=bug_report.md) · [Request Feature](https://github.com/NeoMonserrat/DrumXRoll/issues/new?template=feature_request.md)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/NeoMonserrat/DrumXRoll.git
   cd DrumXRoll
   ```
...
| Name |
|---|
| Dr. Jordan Aiko P. Deja |

Developed under the **Human-X Interactions Lab (HXIL)** — [De La Salle University](https://www.dlsu.edu.ph/)
...
**Antonio Enrique M. Monserrat** — neo.monserrat@gmail.com

Project Link: [https://github.com/NeoMonserrat/DrumXRoll](https://github.com/NeoMonserrat/DrumXRoll)

---

<div align="center">
  <sub>Built with ❤️ by the <a href="https://github.com/NeoMonserrat">DrumXRoll Team</a> @ HXIL, De La Salle University</sub>
</div>
